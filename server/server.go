...
func (bs *BookStoreServer) getAllBooksHandler(w http.ResponseWriter, r *http.Request) {
...
func (bs *BookStoreServer) delBookHandler(w http.ResponseWriter, r *http.Request) {
	id, ok := mux.Vars(r)["id"]
	if !ok {
		http.Error(w, "no id found in request", http.StatusBadRequest)
		return
